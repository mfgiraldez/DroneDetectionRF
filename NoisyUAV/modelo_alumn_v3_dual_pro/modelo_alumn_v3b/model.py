"""
Modelo Dual-Stream V3b — DualStreamCVCNN con 4 features físicas
================================================================
Idéntico a la versión V3a. Arquitectura base para la aplicación de
DivideMix (GMM Loss Weighting) en el bucle de entrenamiento.
"""
import torch
