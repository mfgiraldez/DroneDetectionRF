...
if GLOBAL_CFAR:
    OUT_DIR = r"c:\repos\DroneDetectionRF\NoisyUAV\modelo_v2_2_dual\figuras_golden_filtrado_global"
else:
    OUT_DIR = r"c:\repos\DroneDetectionRF\NoisyUAV\modelo_v2_2_dual\figuras_golden_filtrado_per_window"
FS = 14e6
WIN_LEN = 131072
...
def evaluate_golden():
    ...
    print("\n" + "="*30)
    print(f"GOLDEN SET RESULTS (FILTRADA V2.2)")
