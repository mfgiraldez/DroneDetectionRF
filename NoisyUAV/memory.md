...
> 
> 5. **MIL-Alumn-Xin (El Modelo Definitivo):** La combinación maestra. Utiliza la limpieza del pseudo-etiquetado (Teacher), la representación espacial 2D de Xin, y soluciona el problema de ceguera mediante **MIL (Multiple Instance Learning)**. Si el detector CFAR falla a baja SNR, la red divide los 75ms en ventanas y barre la señal por sí misma, aliviando drásticamente la pérdida de datos.
...
|---|---|---|
| Dron limpio (SNR ≥ 0 dB) | ✅ Correcto | ✅ Correcto |
| Dron + interferentes espurios | ⚠️ FP por bursts BT/WiFi | ✅ SW rechaza espurios aislados |
| Ruido con bursts espurios fuertes | ❌ FP posible | ✅ SW valida sostenimiento |
...
**Estado:** Estructura de directorios refactorizada y probada con éxito. El pipeline definitivo V2.1 está completamente aislado, es modular y autónomo.
